...
public class PaymentOps {
    ...
    public static void main(String[] args) {
        ...
        Account sender = new Account("Ajay" ,"738993278", 73245645.0);
        Account receiver = new Account("Arjun" ,"837492839", 50000.0);
        
        //calling a method in record
    ...
    public static void fundTransfer(Account fromAcc, Account toAcc, double amount, Beneficiary beneficiary) {
        ...
        System.out.println("\nTransferring ₹" + amount + " to " + beneficiary.name() + " (" + beneficiary.bankName() + ")");
